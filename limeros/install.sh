sudo apt install libgtk-3-dev libwebkit2gtk-4.0-dev libayatana-appindicator3-dev build-essential
 ...
 1951  sudo apt install libwebkit2gtk-4.1-dev
 1952  sudo apt install libwebkit2gtk-4.1-dev libgtk-3-dev
 1953  apt search libjavascript
 1954  sudo apt install libjavascriptcoregtk-4.1-dev
 1955  sudo apt install libjavascriptcoregtk-4.1-dev --fix-missing
 1956  sudo apt install libwebkit2gtk-4.1-dev libgtk-3-dev --fix-missing
 1958  sudo apt-get update --error-on-any
 1959  sudo apt-get install -y libwebkit2gtk-4.1-dev libgtk-3-dev
 1961  sudo apt install libjavascriptcoregtk-4.1-dev --fix-missing
 1962  sudo apt autoremove
 1963  sudo apt-get clean
 1964  sudo apt-get update --error-on-any
 1965  sudo apt-get install -y libwebkit2gtk-4.1-dev libgtk-3-dev
 1966  sudo apt-get install -y libwebkit2gtk-4.1-dev libgtk-3-dev --fix-missing
