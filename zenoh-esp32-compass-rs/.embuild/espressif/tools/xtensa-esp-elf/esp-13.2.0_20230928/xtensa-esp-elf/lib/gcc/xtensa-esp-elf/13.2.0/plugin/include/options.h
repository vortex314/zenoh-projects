...
#define MASK_ESP32_PSRAM_FIX_ENA (1U << 3)
#define MASK_FORCE_NO_PIC (1U << 4)
#define MASK_LONGCALLS (1U << 5)
#define MASK_LRA (1U << 6)
#define MASK_SERIALIZE_VOLATILE (1U << 7)
...
enum opt_code
{
  ...
  OPT_mdynconfig_ = 1890,                    /* -mdynconfig= */
  OPT_mextra_l32r_costs_ = 1891,             /* -mextra-l32r-costs= */
  OPT_mfix_esp32_psram_cache_issue = 1892,   /* -mfix-esp32-psram-cache-issue */
  OPT_mfix_esp32_psram_cache_strategy_ = 1893,/* -mfix-esp32-psram-cache-strategy= */
  OPT_mforce_no_pic = 1894,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1895, */              /* -mfused-madd */
  OPT_mlongcalls = 1896,                     /* -mlongcalls */
  OPT_mlra = 1897,                           /* -mlra */
  OPT_mserialize_volatile = 1898,            /* -mserialize-volatile */
  OPT_mtarget_align = 1899,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1900,         /* -mtext-section-literals */
  OPT_n = 1901,                              /* -n */
  OPT_name_sort = 1902,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1903,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1904,              /* -no-integrated-cpp */
  OPT_no_pie = 1905,                         /* -no-pie */
  OPT_nocpp = 1906,                          /* -nocpp */
  OPT_nodefaultlibs = 1907,                  /* -nodefaultlibs */
  OPT_nolibc = 1908,                         /* -nolibc */
  OPT_nophoboslib = 1909,                    /* -nophoboslib */
  OPT_nostartfiles = 1910,                   /* -nostartfiles */
  OPT_nostdinc = 1911,                       /* -nostdinc */
  OPT_nostdinc__ = 1912,                     /* -nostdinc++ */
  OPT_nostdlib = 1913,                       /* -nostdlib */
  OPT_nostdlib__ = 1914,                     /* -nostdlib++ */
  OPT_o = 1915,                              /* -o */
  OPT_objects = 1916,                        /* -objects */
  OPT_p = 1917,                              /* -p */
  OPT_pass_exit_codes = 1918,                /* -pass-exit-codes */
  /* OPT_pedantic = 1919, */                 /* -pedantic */
  OPT_pedantic_errors = 1920,                /* -pedantic-errors */
  OPT_pg = 1921,                             /* -pg */
  OPT_pie = 1922,                            /* -pie */
  OPT_pipe = 1923,                           /* -pipe */
  OPT_print_file_name_ = 1924,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1925,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1926,          /* -print-multi-directory */
  OPT_print_multi_lib = 1927,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1928,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1929,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1930,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1931,               /* -print-prog-name= */
  OPT_print_search_dirs = 1932,              /* -print-search-dirs */
  OPT_print_sysroot = 1933,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1934,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1935,                    /* -print-value */
  OPT_quiet = 1936,                          /* -quiet */
  OPT_r = 1937,                              /* -r */
  OPT_rdynamic = 1938,                       /* -rdynamic */
  ...
  OPT_static_libgm2 = 1954,                  /* -static-libgm2 */
  OPT_static_libgo = 1955,                   /* -static-libgo */
  OPT_static_libhwasan = 1956,               /* -static-libhwasan */
  OPT_static_liblsan = 1957,                 /* -static-liblsan */
  OPT_static_libmpx = 1958,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1959,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1960,               /* -static-libphobos */
  OPT_static_libquadmath = 1961,             /* -static-libquadmath */
  OPT_static_libstdc__ = 1962,               /* -static-libstdc++ */
  OPT_static_libtsan = 1963,                 /* -static-libtsan */
  OPT_static_libubsan = 1964,                /* -static-libubsan */
  OPT_static_pie = 1965,                     /* -static-pie */
  /* OPT_std_c__03 = 1966, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1967, */                /* -std=c++0x */
  OPT_std_c__11 = 1968,                      /* -std=c++11 */
  OPT_std_c__14 = 1969,                      /* -std=c++14 */
  OPT_std_c__17 = 1970,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1971, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1972, */                /* -std=c++1z */
  OPT_std_c__20 = 1973,                      /* -std=c++20 */
  OPT_std_c__23 = 1974,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1975, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1976, */                /* -std=c++2b */
  OPT_std_c__98 = 1977,                      /* -std=c++98 */
  OPT_std_c11 = 1978,                        /* -std=c11 */
  OPT_std_c17 = 1979,                        /* -std=c17 */
  /* OPT_std_c18 = 1980, */                  /* -std=c18 */
  /* OPT_std_c1x = 1981, */                  /* -std=c1x */
  OPT_std_c2x = 1982,                        /* -std=c2x */
  /* OPT_std_c89 = 1983, */                  /* -std=c89 */
  OPT_std_c90 = 1984,                        /* -std=c90 */
  OPT_std_c99 = 1985,                        /* -std=c99 */
  /* OPT_std_c9x = 1986, */                  /* -std=c9x */
  OPT_std_f2003 = 1987,                      /* -std=f2003 */
  OPT_std_f2008 = 1988,                      /* -std=f2008 */
  OPT_std_f2008ts = 1989,                    /* -std=f2008ts */
  OPT_std_f2018 = 1990,                      /* -std=f2018 */
  OPT_std_f95 = 1991,                        /* -std=f95 */
  OPT_std_gnu = 1992,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1993, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1994, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1995,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1996,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1997,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1998, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1999, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2000,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2001,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2002, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2003, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2004,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2005,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2006,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2007, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2008, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2009,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2010, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2011,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2012,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2013, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2014, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2015,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2016, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2017, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2018, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2019, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2020, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2021,                     /* -std=legacy */
  OPT_stdlib_ = 2022,                        /* -stdlib= */
  OPT_symbol_ = 2023,                        /* -symbol= */
  OPT_symbolic = 2024,                       /* -symbolic */
  OPT_t = 2025,                              /* -t */
  OPT_time = 2026,                           /* -time */
  OPT_time_ = 2027,                          /* -time= */
  OPT_traditional = 2028,                    /* -traditional */
  OPT_traditional_cpp = 2029,                /* -traditional-cpp */
  OPT_tree_stats = 2030,                     /* -tree-stats */
  OPT_trigraphs = 2031,                      /* -trigraphs */
  OPT_type_stats = 2032,                     /* -type-stats */
  OPT_u = 2033,                              /* -u */
  OPT_undef = 2034,                          /* -undef */
  OPT_v = 2035,                              /* -v */
  OPT_version = 2036,                        /* -version */
  OPT_w = 2037,                              /* -w */
  OPT_wrapper = 2038,                        /* -wrapper */
  OPT_x = 2039,                              /* -x */
  OPT_z = 2040,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
