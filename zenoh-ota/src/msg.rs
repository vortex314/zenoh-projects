...
pub struct Ps4Map {
    ...
    #[n(12)] pub stick_left_x: Option<i32>,
    #[n(13)] pub stick_left_y: Option<i32>,
    #[n(14)] pub stick_right_x: Option<i32>,
    #[n(15)] pub stick_right_y: Option<i32>,
    #[n(16)] pub gyro_x: Option<i32>,
    #[n(17)] pub gyro_y: Option<i32>,
    #[n(18)] pub gyro_z: Option<i32>,
...
#[cbor(array)]
pub struct OtaMsg {
    #[n(0)] pub operation : Option<OtaOperation>,
    #[n(1)] pub offset : Option<u32>,
    #[n(2)] pub image : Option<Vec<u8>>,
    #[n(3)] pub rc : Option<i32>,
    #[n(4)] pub message : Option<String>,
    #[n(5)] pub reply_to : Option<String>,
}
